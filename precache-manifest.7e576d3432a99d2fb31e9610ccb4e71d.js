var slConfig = {
  ...
  "buildSessionId": "f06d738a-82a7-494a-99c6-d299c703ce67",
  "enabled": true,
...
if(window && window.$SealightsAgent){
   ...
   window.$Sealights.components["f06d738a-82a7-494a-99c6-d299c703ce67"] = slConfig;   document.addEventListener("DOMContentLoaded", function(event) {
